...
/**
 * Main class of the example. Send a task to the executor that will execute every two seconds. Then,
 * control the remaining time for the next execution of the task
 *
 */
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // Create a new task and sends it to the executor. It will start with a delay of 1 second and
    // then
