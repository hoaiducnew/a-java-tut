...
/**
 * Creates two user validation systems and execute them in an Executor using the invokeAny() method.
 * If the user is validated by one of the user validation systems, then it shows a message. If both
 * system don't validate the user, the application proccess the ExecutionException throwed by the
 * method
 */
public class Main {
